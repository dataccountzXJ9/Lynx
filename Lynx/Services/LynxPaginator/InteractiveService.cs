...
namespace Lynx.Interactive
{
    public class InteractiveService : IDisposable
    {
        ...
        public async Task<IUserMessage> ReplyAndDeleteAsync(LynxContext context, string content, bool isTTS = false, Embed embed = null, TimeSpan? timeout = null, RequestOptions options = null)
        {
            timeout = timeout ?? _defaultTimeout;
        ...
        public async Task<IUserMessage> SendPaginatedMessageAsync(LynxContext context, PaginatedMessage pager, ICriterion<SocketReaction> criterion = null)
        {
